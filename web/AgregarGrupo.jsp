...
<html>
    ...
    <body>
        <div class="w3-container">
                              <form class="form-horizontal" method="post"  role="form" action="AgregarGrupoMain.jsp" >
                                <h3> Participantes </h3>
                                <%
                                    String Name = "";
                                ...
                                <button type="submit" value="enviar" href="#" class="w3-button w3-block">Agregar</button>
                              <br>
                              </form>
                            </div>
    </body>
