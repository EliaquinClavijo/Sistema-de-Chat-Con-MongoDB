                  ...
                  <div class="w3-row-padding">
                    ...
                    <form  id="Menu_1" name="Yuli" method="POST">
                      ...
                      <div class="w3-white w3-text-grey w3-card-4">
                            ...
                            <hr>
                            <div class="w3-container">
                                <% if (usuario.equals("Eliaquin")){%> 
                                <p><i class="fa fa-cog fa-fw w3-margin-right w3-large w3-text-blue-grey"></i><a  href="Root.jsp"> Root </a></p>
                                <%}%>
                    ...
                    <div class="w3-twothird" id="Replace1">
                      <div class="w3-container w3-card w3-white w3-margin-bottom">
                        <h3 class="w3-text-grey w3-padding-16">...</h3>
                        <div class="w3-container">
